...
public class VoteDialog extends JPanel {
    ...
    private JPanel createSimpleDialogBox() {
        ...
        checkBoxes[0] = new JCheckBox("<html>Candidate 1: <font color=red>Sparky the Dog</font></html>");
        checkBoxes[0].setActionCommand(defaultMessageCommand);
        
        checkBoxes[1] = new JCheckBox(
          "<html>Candidate 2: <font color=green>Shady Sadie</font></html>");
        checkBoxes[1].setActionCommand(yesNoCommand);

        checkBoxes[2] = new JCheckBox(
          "<html>Candidate 3: <font color=blue>R.I.P. McDaniels</font></html>");
        checkBoxes[2].setActionCommand(yeahNahCommand);
        ...
        checkBoxes[3].setActionCommand(yncCommand);
...
/*        radioButtons[0] = new JRadioButton(
        ...
        ;
        checkBoxes[2].addChangeListener(new ChangeListener() {
        	@Override
            public void stateChanged(ChangeEvent e) {        
        ...
        checkBoxes[3].addChangeListener(new ChangeListener(){
